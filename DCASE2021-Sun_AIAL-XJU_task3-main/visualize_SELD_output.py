...
pred = os.path.join(params['dcase_output_dir'], '4_foa_dev_test/fold6_room1_mix018.csv')
...
aud_dir = os.path.join(params['dataset_dir'], 'foa_dev/dev-test')
...
plot.savefig(fig_file, dpi=600, bbox_inches = "tight")
