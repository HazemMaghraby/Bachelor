...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        # INPUT PATH
        dataset_dir='C:/Users/dell/Downloads/Bachelor/data',  # Base folder containing the foa_dev/mic_dev and metadata folders

        # OUTPUT PATH
        feat_label_dir='C:/Users/dell/Downloads/Bachelor/feat_label/',  # Directory to dump extracted features and labels
        model_dir='C:/Users/dell/Downloads/Bachelor/models/',            # Dumps the trained models and training curves in this folder
        dcase_output_dir='C:/Users/dell/Downloads/Bachelor/result/',    # recording-wise results are dumped in this path.
